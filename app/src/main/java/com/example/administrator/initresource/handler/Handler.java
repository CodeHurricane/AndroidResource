...
package com.example.administrator.initresource.handler;
...
public class Handler {
    ...
    /**
     * Use the {@link android.os.Looper} for the current thread
     ...
     * the synchronization barriers introduced by {@link android.os.MessageQueue#enqueueSyncBarrier(long)}.
     *
    ...
    /**
     * Use the {@link android.os.Looper} for the current thread with the specified callback interface
     * and set whether the handler should be asynchronous.
     *
     * Handlers are synchronous by default unless this constructor is used to make
     * one that is strictly asynchronous.
     ...
     * @hide
     */
    public Handler(android.os.Looper looper, Callback callback, boolean async) {
        mLooper = looper;
